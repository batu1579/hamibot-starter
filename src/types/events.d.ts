...
declare module 'events' {
    global {
        ...
        class Events extends EventEmitter {
             ...
             * ```
             */
            onKeyDown(keyName: KeyName, listener: (event: KeyEventObject) => any): this;
             ...
             * ```
             */
            onKeyUp(keyName: KeyName, listener: (event: KeyEventObject) => any): this;
             ...
             * @return {this} 返回自身以便链式调用。
             */
            onceKeyDown(keyName: KeyName, listener: (event: KeyEventObject) => any): this;
             ...
             * @return {this} 返回自身以便链式调用。
             */
            onceKeyUp(keyName: KeyName, listener: (event: KeyEventObject) => any): this;
        ...
        interface _KeyEvent {
             ...
             * @description: 主页键。
             */
            readonly KEYCODE_HOME: number;

            /**
             * @description: 返回键。
             */
            readonly KEYCODE_BACK: number;
            
            /**
             * @description: 菜单键。
             */
            readonly KEYCODE_MENU: number;

            /**
             * @description: 音量上键。
             */
            readonly KEYCODE_VOLUME_UP: number;

            /**
             * @description: 音量下键。
             */
            readonly KEYCODE_VOLUME_DOWN: number;
        }
