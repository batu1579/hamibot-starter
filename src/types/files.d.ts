declare module "files" {
    global {
        ...
        interface Files {
             ...
             */
            open(path: string, mode?: "w" | "a" | "rw", encoding?: encode, bufferSize?: number): WritableTextFile;
             ...
             * @return {WritableTextFile} 打开的文件对象
             */
            open(path: string, mode?: "w" | "a" | "rw", encoding?: string, bufferSize?: number): WritableTextFile;
        }
